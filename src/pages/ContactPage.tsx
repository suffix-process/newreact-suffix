...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-teal-700 to-teal-500 text-white py-12 px-[65px]">
      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          ...
          {/* Prefer to Talk */}
          <div className="bg-[#304168] text-white p-6 rounded shadow">
            <h3 className="font-semibold mb-2">Prefer to talk?</h3>
            <p className="mb-4">You can reach us at <strong>93768 84752</strong><br/>Mon–Sat, 9am–7pm IST</p>
