...
const slides: Slide[] = [
  {
    ...
    subtitle:
      "Technology led solutions to improve experiences, drive efficiency and reduce cost.",
  ...
  },
  {
    ...
    subtitle:
      "Process solutions that lower costs and lead to lasting relationships",
  ...
  },
  {
    ...
    subtitle:
      "End-to-end BFSI solutions secured by ISO-certified data protection practices.",
    buttonText: "See how",
    buttonLink: "#",
    image:
  ...
  // },
  {
    ...
    subtitle:
      "Deploy our skilled manpower at your premises or ours, secured by stringent Infosec protocols.",
    buttonText: "See how",
    buttonLink: "#",
    image:
      "https://images.pexels.com/photos/3183152/pexels-photo-3183152.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    id: 6,
    title: "Precision in Every Process",
    subtitle:
      "Expert-led BFSI workflows delivering accuracy, efficiency, and cost-effectiveness at scale.",
    buttonText: "See how",
    buttonLink: "#",
    image:
  ...
  },
  {
    ...
    subtitle:
      "Cutting-edge technology paired with highly skilled personnel ensures flawless execution.",
    buttonText: "See how",
    buttonLink: "#",
    image:
      "https://images.pexels.com/photos/3183154/pexels-photo-3183154.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    id: 8,
    title: "Reliable Infrastructure, Remarkable Results",
    subtitle:
      "Robust IT infrastructure ensuring dependable, uninterrupted service delivery.",
    buttonText: "See how",
    buttonLink: "#",
    image:
  ...
  },
  {
    ...
    subtitle:
      "Intelligent AI and automation solutions to supercharge efficiency and reduce costs.",
    buttonText: "See how",
    buttonLink: "#",
    image:
  ...
  },
  {
    ...
    subtitle:
      "RPA-driven automation that accelerates processes, minimizes errors, and optimizes cost.",
    buttonText: "See how",
    buttonLink: "#",
    image:
      "https://images.pexels.com/photos/3183157/pexels-photo-3183157.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
];
...
const HeroSlider: React.FC = () => {
  ...
  return (
    <div className=" relative h-[500px] md:h-[600px] lg:h-[565px] overflow-hidden">
      {slides.map((slide, i) => (
        <div
          key={slide.id}
