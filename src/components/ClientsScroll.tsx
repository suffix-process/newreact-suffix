...
import indusLogo from '../assets/logos/indus.jpg';
import shriramLogo from '../assets/logos/shriram.jpg';
...
const ClientsScroll: FC = () => {
  return (
    <div>
      <section className="py-4 md:py-1 bg-[#ffff]">


        <div className="relative overflow-hidden py-1 md:py-6 bg-[#f5f2f3]">

          <div className="absolute inset-y-0 left-0 w-[20%] md:w-[15%] bg-[#bfbfbf] z-10 [clip-path:polygon(0_0,100%_0,80%_100%,0_100%)]" />
          <div className="absolute inset-y-0 left-[10%] w-[20%] md:w-[15%] bg-gradient-to-r from-[#4079ff] to-[#38ffee]/70 z-10 [clip-path:polygon(33%_0,100%_0,70%_100%,0%_100%)]" />
