      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="hidden md:grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-400">
              Suffix delivers mission-critical services and solutions on behalf
            ...
            <div className="flex space-x-4 mt-6">
              ...
              >
                ...
                <FontAwesomeIcon icon={faLinkedinIn} bounce />
              </a>
              <a
                href="#"
                className="text-gray-400 hover:text-white transition-colors"
        ...
        <div className="md:hidden flex flex-col items-center space-y-6">
          ...
          <div className="text-center text-gray-400 px-6">
            Suffix delivers mission-critical services and solutions on behalf of
